...
// import { Users, User, Phone, Mail, MapPin, Building2, Flag, FileText } from 'lucide-react'
...
//                 className="bg-gray-900/80 border-gray-700 text-white pl-10 h-11"
//               />
//             </div>
//             {teamErrors.teamName && (
//               <p className="text-red-400 text-xs mt-1">{teamErrors.teamName.message}</p>
//             )}
//           </div>
...
//                 <p className="text-red-400 text-xs mt-1">{teamErrors.captainName.message}</p>
//               )}
//             </div>
...
//                   className="w-full h-11 bg-gray-900/80 border border-gray-700 text-white rounded-md px-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
//                 >
...
//                   className="bg-gray-900/80 border-gray-700 text-white pl-10 min-h-[70px]"
//                 />
//               </div>
//               {teamErrors.address && (
