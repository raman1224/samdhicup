...
//           .section h2 { color: #F97316; margin-top: 0; }
//           table { width: 100%; border-collapse: collapse; }
//           th, td { padding: 8px; text-align: left; border-bottom: 1px solid #ddd; }
//           th { background: #f5f5f5; }
//           .badge { padding: 4px 8px; border-radius: 4px; font-size: 12px; }
//           .approved { background: #22C55E; color: white; }
//           .pending { background: #EAB308; color: white; }
//           .rejected { background: #EF4444; color: white; }
//         </style>
//       </head>
//       <body>
//         <h1>🏐 Team Registration - ${team.registrationId}</h1>
        
//         <div class="section">
//           <h2>Team Information</h2>
//           <p><strong>Team Name:</strong> ${team.teamName}</p>
//           <p><strong>Registration ID:</strong> ${team.registrationId}</p>
//           <p><strong>Status:</strong> <span class="badge ${team.status}">${team.status.toUpperCase()}</span></p>
//         </div>

//         <div class="section">
//           <h2>Captain Details</h2>
//           <p><strong>Name:</strong> ${team.captainName}</p>
...
//           <p><strong>Municipality:</strong> ${team.municipality}</p>
...
//           <p><strong>Transaction ID:</strong> ${team.payment.transactionId}</p>
//           <p><strong>Method:</strong> ${team.payment.paymentMethod}</p>
//           <p><strong>Amount:</strong> NPR ${team.payment.amount?.toLocaleString()}</p>
//           <p><strong>Status:</strong> <span class="badge ${team.payment.status}">${team.payment.status.toUpperCase()}</span></p>
//         </div>
//         ` : ''}
...
//           Generated on ${new Date().toLocaleString()} | Volleyball Tournament 2026
//         </p>
//       </body>
//       </html>
//     `
...
//         'Content-Disposition': `attachment; filename="${team.registrationId}-${team.teamName.replace(/\s+/g, '-')}.html"`,
//       },
//     })
//   } catch (error) {
